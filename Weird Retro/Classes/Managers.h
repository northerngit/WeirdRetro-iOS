...
#define kMainTextOptions @{DTDefaultFontFamily:@"Lato",\
                        DTDefaultFontName:@"Lato-Regular",\
...
#define kTitleTextOptions @{DTDefaultFontFamily:@"KomikaAxis",\
        DTDefaultFontName:@"KomikaAxis",\
        DTDefaultLinkColor:kMainTextColor,\
        DTDefaultTextColor:[UIColor colorWithRed:98.f/255.f green:98.f/255.f blue:98.f/255.f alpha:1.0],\
        DTDefaultLinkDecoration:@NO,\
        DTDefaultFontSize:@23,\
        DTDefaultLineHeightMultiplier:@1.1f,\
        DTUseiOS6Attributes:@YES}
